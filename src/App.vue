        ...
        <Popover class="relative">
          ...
          >
            ...
            >
              <div class="p-4">
                ...
                >
                  ...
                  >
                    <component
                      :is="item.icon"
                      class="h-6 w-6 text-gray-400 group-hover:text-indigo-300"
                      aria-hidden="true"
                    />
                  </div>
                  <div class="flex-auto">
              ...
              <div class="grid grid-cols-2 divide-x divide-gray-700 bg-gray-800">
                <a
                  v-for="item in callsToAction"
                  :key="item.name"
                  :href="item.href"
                  class="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-white hover:bg-gray-700"
                >
                  <component
                    :is="item.icon"
          ...
          <div class="-my-6 divide-y divide-gray-500">
            <div class="space-y-2 py-6">
              <Disclosure as="div" class="-mx-3" v-slot="{ open }">
                <DisclosureButton
                  class="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-gray-700"
                >
                  Product
                  <ChevronDownIcon
                ...
                <DisclosurePanel class="mt-2 space-y-2">
                  <DisclosureButton
                    ...
                    as="a"
                    :href="item.href"
                    class="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-white hover:bg-gray-700"
              ...
              <a
                href="#"
                class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-700"
                >Features</a
              >
              <a
                href="#"
            ...
            <div class="py-6">
              <a
                href="#"
                class="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semibold leading-7 text-white hover:bg-gray-700"
                >Log in</a
              >
            </div>
          </div>
